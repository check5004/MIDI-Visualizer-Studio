...
mixin _$EditorState {
 ...
 EditorStatus get status; Project? get project; Set<String> get selectedComponentIds; EditorMode get mode; double get zoomLevel; EditorTool get currentTool; List<Offset> get currentPathPoints; bool get showGrid; bool get snapToGrid; double get gridSize; int get floodFillTolerance; Set<String> get activeComponentIds; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditorState&&(identical(other.status, status) || other.status == status)&&(identical(other.project, project) || other.project == project)&&const DeepCollectionEquality().equals(other.selectedComponentIds, selectedComponentIds)&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.zoomLevel, zoomLevel) || other.zoomLevel == zoomLevel)&&(identical(other.currentTool, currentTool) || other.currentTool == currentTool)&&const DeepCollectionEquality().equals(other.currentPathPoints, currentPathPoints)&&(identical(other.showGrid, showGrid) || other.showGrid == showGrid)&&(identical(other.snapToGrid, snapToGrid) || other.snapToGrid == snapToGrid)&&(identical(other.gridSize, gridSize) || other.gridSize == gridSize)&&(identical(other.floodFillTolerance, floodFillTolerance) || other.floodFillTolerance == floodFillTolerance)&&const DeepCollectionEquality().equals(other.activeComponentIds, activeComponentIds)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,status,project,const DeepCollectionEquality().hash(selectedComponentIds),mode,zoomLevel,currentTool,const DeepCollectionEquality().hash(currentPathPoints),showGrid,snapToGrid,gridSize,floodFillTolerance,const DeepCollectionEquality().hash(activeComponentIds),errorMessage);

@override
String toString() {
  return 'EditorState(status: $status, project: $project, selectedComponentIds: $selectedComponentIds, mode: $mode, zoomLevel: $zoomLevel, currentTool: $currentTool, currentPathPoints: $currentPathPoints, showGrid: $showGrid, snapToGrid: $snapToGrid, gridSize: $gridSize, floodFillTolerance: $floodFillTolerance, activeComponentIds: $activeComponentIds, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 EditorStatus status, Project? project, Set<String> selectedComponentIds, EditorMode mode, double zoomLevel, EditorTool currentTool, List<Offset> currentPathPoints, bool showGrid, bool snapToGrid, double gridSize, int floodFillTolerance, Set<String> activeComponentIds, String? errorMessage
});
...
/// Create a copy of EditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? project = freezed,Object? selectedComponentIds = null,Object? mode = null,Object? zoomLevel = null,Object? currentTool = null,Object? currentPathPoints = null,Object? showGrid = null,Object? snapToGrid = null,Object? gridSize = null,Object? floodFillTolerance = null,Object? activeComponentIds = null,Object? errorMessage = freezed,}) {
...
as int,activeComponentIds: null == activeComponentIds ? _self.activeComponentIds : activeComponentIds // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EditorStatus status,  Project? project,  Set<String> selectedComponentIds,  EditorMode mode,  double zoomLevel,  EditorTool currentTool,  List<Offset> currentPathPoints,  bool showGrid,  bool snapToGrid,  double gridSize,  int floodFillTolerance,  Set<String> activeComponentIds,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EditorState() when $default != null:
return $default(_that.status,_that.project,_that.selectedComponentIds,_that.mode,_that.zoomLevel,_that.currentTool,_that.currentPathPoints,_that.showGrid,_that.snapToGrid,_that.gridSize,_that.floodFillTolerance,_that.activeComponentIds,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EditorStatus status,  Project? project,  Set<String> selectedComponentIds,  EditorMode mode,  double zoomLevel,  EditorTool currentTool,  List<Offset> currentPathPoints,  bool showGrid,  bool snapToGrid,  double gridSize,  int floodFillTolerance,  Set<String> activeComponentIds,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _EditorState():
return $default(_that.status,_that.project,_that.selectedComponentIds,_that.mode,_that.zoomLevel,_that.currentTool,_that.currentPathPoints,_that.showGrid,_that.snapToGrid,_that.gridSize,_that.floodFillTolerance,_that.activeComponentIds,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EditorStatus status,  Project? project,  Set<String> selectedComponentIds,  EditorMode mode,  double zoomLevel,  EditorTool currentTool,  List<Offset> currentPathPoints,  bool showGrid,  bool snapToGrid,  double gridSize,  int floodFillTolerance,  Set<String> activeComponentIds,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _EditorState() when $default != null:
return $default(_that.status,_that.project,_that.selectedComponentIds,_that.mode,_that.zoomLevel,_that.currentTool,_that.currentPathPoints,_that.showGrid,_that.snapToGrid,_that.gridSize,_that.floodFillTolerance,_that.activeComponentIds,_that.errorMessage);case _:
  return null;
...
class _EditorState implements EditorState {
  const _EditorState({this.status = EditorStatus.initial, this.project, final  Set<String> selectedComponentIds = const {}, this.mode = EditorMode.edit, this.zoomLevel = 1.0, this.currentTool = EditorTool.select, final  List<Offset> currentPathPoints = const [], this.showGrid = true, this.snapToGrid = false, this.gridSize = 20.0, this.floodFillTolerance = 10, final  Set<String> activeComponentIds = const {}, this.errorMessage}): _selectedComponentIds = selectedComponentIds,_currentPathPoints = currentPathPoints,_activeComponentIds = activeComponentIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EditorState&&(identical(other.status, status) || other.status == status)&&(identical(other.project, project) || other.project == project)&&const DeepCollectionEquality().equals(other._selectedComponentIds, _selectedComponentIds)&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.zoomLevel, zoomLevel) || other.zoomLevel == zoomLevel)&&(identical(other.currentTool, currentTool) || other.currentTool == currentTool)&&const DeepCollectionEquality().equals(other._currentPathPoints, _currentPathPoints)&&(identical(other.showGrid, showGrid) || other.showGrid == showGrid)&&(identical(other.snapToGrid, snapToGrid) || other.snapToGrid == snapToGrid)&&(identical(other.gridSize, gridSize) || other.gridSize == gridSize)&&(identical(other.floodFillTolerance, floodFillTolerance) || other.floodFillTolerance == floodFillTolerance)&&const DeepCollectionEquality().equals(other._activeComponentIds, _activeComponentIds)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,status,project,const DeepCollectionEquality().hash(_selectedComponentIds),mode,zoomLevel,currentTool,const DeepCollectionEquality().hash(_currentPathPoints),showGrid,snapToGrid,gridSize,floodFillTolerance,const DeepCollectionEquality().hash(_activeComponentIds),errorMessage);
...
/// Create a copy of EditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? project = freezed,Object? selectedComponentIds = null,Object? mode = null,Object? zoomLevel = null,Object? currentTool = null,Object? currentPathPoints = null,Object? showGrid = null,Object? snapToGrid = null,Object? gridSize = null,Object? floodFillTolerance = null,Object? activeComponentIds = null,Object? errorMessage = freezed,}) {
...
as bool,gridSize: null == gridSize ? _self.gridSize : gridSize // ignore: cast_nullable_to_non_nullable
as double,floodFillTolerance: null == floodFillTolerance ? _self.floodFillTolerance : floodFillTolerance // ignore: cast_nullable_to_non_nullable
as int,activeComponentIds: null == activeComponentIds ? _self._activeComponentIds : activeComponentIds // ignore: cast_nullable_to_non_nullable
as Set<String>,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
