...
return interactionEnd(_that);case StartDrawing() when startDrawing != null:
return startDrawing(_that);case UpdateDrawing() when updateDrawing != null:
return updateDrawing(_that);case FinishDrawing() when finishDrawing != null:
return finishDrawing(_that);case CreatePadGrid() when createPadGrid != null:
return createPadGrid(_that);case RestoreSession() when restoreSession != null:
return restoreSession(_that);case DiscardSession() when discardSession != null:
return discardSession(_that);case _:
  return orElse();
...
return interactionEnd(_that);case StartDrawing():
return startDrawing(_that);case UpdateDrawing():
return updateDrawing(_that);case FinishDrawing():
return finishDrawing(_that);case CreatePadGrid():
return createPadGrid(_that);case RestoreSession():
return restoreSession(_that);case DiscardSession():
return discardSession(_that);case _:
...
return interactionEnd();case StartDrawing() when startDrawing != null:
return startDrawing(_that.point);case UpdateDrawing() when updateDrawing != null:
return updateDrawing(_that.point,_that.isShift,_that.isAlt);case FinishDrawing() when finishDrawing != null:
return finishDrawing();case CreatePadGrid() when createPadGrid != null:
return createPadGrid(_that.rows,_that.columns);case RestoreSession() when restoreSession != null:
return restoreSession();case DiscardSession() when discardSession != null:
return discardSession();case _:
  return orElse();
...
return interactionEnd();case StartDrawing():
return startDrawing(_that.point);case UpdateDrawing():
return updateDrawing(_that.point,_that.isShift,_that.isAlt);case FinishDrawing():
return finishDrawing();case CreatePadGrid():
return createPadGrid(_that.rows,_that.columns);case RestoreSession():
return restoreSession();case DiscardSession():
return discardSession();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Project? project,  String path)?  loadProject,TResult? Function( double zoom,  Offset offset)?  updateViewTransform,TResult? Function( Size size)?  updateViewportSize,TResult? Function()?  centerOnContent,TResult? Function( Component component)?  addComponent,TResult? Function( String id,  Component component)?  updateComponent,TResult? Function( List<Component> components)?  updateComponents,TResult? Function( String id,  bool multiSelect)?  selectComponent,TResult? Function( List<String> ids,  bool multiSelect)?  selectComponents,TResult? Function( int oldIndex,  int newIndex)?  reorderComponent,TResult? Function( Project project)?  updateProjectSettings,TResult? Function( EditorMode mode)?  toggleMode,TResult? Function( double zoom)?  setZoom,TResult? Function()?  zoomIn,TResult? Function()?  zoomOut,TResult? Function( EditorTool tool)?  selectTool,TResult? Function( Offset point)?  addPathPoint,TResult? Function()?  finishPath,TResult? Function()?  cancelPath,TResult? Function( Project project)?  restoreProject,TResult? Function()?  undo,TResult? Function()?  redo,TResult? Function()?  toggleGrid,TResult? Function()?  toggleSnapToGrid,TResult? Function( double size)?  setGridSize,TResult? Function( MidiPacket packet)?  handleMidiMessage,TResult? Function()?  saveProject,TResult? Function( String path)?  exportProject,TResult? Function( String componentId,  Offset position,  Color color)?  fillImageArea,TResult? Function( int tolerance)?  setFloodFillTolerance,TResult? Function()?  copy,TResult? Function()?  paste,TResult? Function()?  cut,TResult? Function()?  delete,TResult? Function()?  duplicate,TResult? Function()?  interactionStart,TResult? Function()?  interactionEnd,TResult? Function( Offset point)?  startDrawing,TResult? Function( Offset point,  bool isShift,  bool isAlt)?  updateDrawing,TResult? Function()?  finishDrawing,TResult? Function( int rows,  int columns)?  createPadGrid,TResult? Function()?  restoreSession,TResult? Function()?  discardSession,}) {final _that = this;
switch (_that) {
case LoadProject() when loadProject != null:
return loadProject(_that.project,_that.path);case UpdateViewTransform() when updateViewTransform != null:
return updateViewTransform(_that.zoom,_that.offset);case UpdateViewportSize() when updateViewportSize != null:
...
class StartDrawing implements EditorEvent {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$StartDrawingCopyWith<StartDrawing> get copyWith => _$StartDrawingCopyWithImpl<StartDrawing>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StartDrawing&&(identical(other.point, point) || other.point == point));
}
...
@override
String toString() {
  return 'EditorEvent.startDrawing(point: $point)';
}
...
/// @nodoc
abstract mixin class $StartDrawingCopyWith<$Res> implements $EditorEventCopyWith<$Res> {
  factory $StartDrawingCopyWith(StartDrawing value, $Res Function(StartDrawing) _then) = _$StartDrawingCopyWithImpl;
@useResult
$Res call({
 Offset point
});
...
/// @nodoc
class _$StartDrawingCopyWithImpl<$Res>
    implements $StartDrawingCopyWith<$Res> {
  _$StartDrawingCopyWithImpl(this._self, this._then);

  final StartDrawing _self;
  final $Res Function(StartDrawing) _then;

/// Create a copy of EditorEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? point = null,}) {
  return _then(StartDrawing(
null == point ? _self.point : point // ignore: cast_nullable_to_non_nullable
as Offset,
  ));
}
...
class UpdateDrawing implements EditorEvent {
  const UpdateDrawing(this.point, {this.isShift = false, this.isAlt = false});
  

 final  Offset point;
@JsonKey() final  bool isShift;
@JsonKey() final  bool isAlt;

/// Create a copy of EditorEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdateDrawingCopyWith<UpdateDrawing> get copyWith => _$UpdateDrawingCopyWithImpl<UpdateDrawing>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateDrawing&&(identical(other.point, point) || other.point == point)&&(identical(other.isShift, isShift) || other.isShift == isShift)&&(identical(other.isAlt, isAlt) || other.isAlt == isAlt));
}


@override
int get hashCode => Object.hash(runtimeType,point,isShift,isAlt);

@override
String toString() {
  return 'EditorEvent.updateDrawing(point: $point, isShift: $isShift, isAlt: $isAlt)';
}
...
/// @nodoc
abstract mixin class $UpdateDrawingCopyWith<$Res> implements $EditorEventCopyWith<$Res> {
  factory $UpdateDrawingCopyWith(UpdateDrawing value, $Res Function(UpdateDrawing) _then) = _$UpdateDrawingCopyWithImpl;
@useResult
$Res call({
 Offset point, bool isShift, bool isAlt
});
...
/// @nodoc
class _$UpdateDrawingCopyWithImpl<$Res>
    implements $UpdateDrawingCopyWith<$Res> {
  _$UpdateDrawingCopyWithImpl(this._self, this._then);

  final UpdateDrawing _self;
  final $Res Function(UpdateDrawing) _then;

/// Create a copy of EditorEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? point = null,Object? isShift = null,Object? isAlt = null,}) {
  return _then(UpdateDrawing(
null == point ? _self.point : point // ignore: cast_nullable_to_non_nullable
as Offset,isShift: null == isShift ? _self.isShift : isShift // ignore: cast_nullable_to_non_nullable
...
class FinishDrawing implements EditorEvent {
  const FinishDrawing();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FinishDrawing);
}
...
@override
String toString() {
  return 'EditorEvent.finishDrawing()';
}
...
class CreatePadGrid implements EditorEvent {
  const CreatePadGrid(this.rows, this.columns);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CreatePadGridCopyWith<CreatePadGrid> get copyWith => _$CreatePadGridCopyWithImpl<CreatePadGrid>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreatePadGrid&&(identical(other.rows, rows) || other.rows == rows)&&(identical(other.columns, columns) || other.columns == columns));
}
...
@override
String toString() {
  return 'EditorEvent.createPadGrid(rows: $rows, columns: $columns)';
}
...
/// @nodoc
abstract mixin class $CreatePadGridCopyWith<$Res> implements $EditorEventCopyWith<$Res> {
  factory $CreatePadGridCopyWith(CreatePadGrid value, $Res Function(CreatePadGrid) _then) = _$CreatePadGridCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CreatePadGridCopyWithImpl<$Res>
    implements $CreatePadGridCopyWith<$Res> {
  _$CreatePadGridCopyWithImpl(this._self, this._then);

  final CreatePadGrid _self;
  final $Res Function(CreatePadGrid) _then;

/// Create a copy of EditorEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? rows = null,Object? columns = null,}) {
  return _then(CreatePadGrid(
null == rows ? _self.rows : rows // ignore: cast_nullable_to_non_nullable
as int,null == columns ? _self.columns : columns // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class RestoreSession implements EditorEvent {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RestoreSession);
}
...
@override
String toString() {
  return 'EditorEvent.restoreSession()';
}
...
class DiscardSession implements EditorEvent {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DiscardSession);
}
...
@override
String toString() {
  return 'EditorEvent.discardSession()';
}
