                    ...
                    child: Row(
                      children: [
                            ...
                            if (result != null && result.files.single.path != null) {
                              if (context.mounted) {
                                context.read<EditorBloc>().add(
                                  EditorEvent.loadProject(path: result.files.single.path!),
                                );
                              }
                            }
                          },
                        ...
                        IconButton(
                          ...
                          tooltip: 'Bucket Fill',
                          color: state.currentTool == EditorTool.bucketFill
                              ? Theme.of(context).colorScheme.primary
                              : null,
                          onPressed: () {
                          ...
                          onSelected: (value) async {
                            if (value == 'pad_grid') {
                              ...
                              if (result != null && context.mounted) {
                                context.read<EditorBloc>().add(
                                  EditorEvent.createPadGrid(result['rows']!, result['cols']!),
                                );
                              }
                            }
                          },
