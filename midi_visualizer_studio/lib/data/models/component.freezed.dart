...
@JsonKey() final  bool pulseModeEnabled;
@JsonKey() final  int pulseDuration;
...
as EffectConfig?,pulseModeEnabled: null == pulseModeEnabled ? _self.pulseModeEnabled : pulseModeEnabled // ignore: cast_nullable_to_non_nullable
as bool,pulseDuration: null == pulseDuration ? _self.pulseDuration : pulseDuration // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
